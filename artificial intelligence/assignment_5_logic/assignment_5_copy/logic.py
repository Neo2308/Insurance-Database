...
class And(BinaryFormula):
    ...
    def truthValue(self, truthDict):
        ...
        a=self.arg1.truthValue(truthDict)
        b=self.arg2.truthValue(truthDict)
        return(a and b)
...
class Or(BinaryFormula):
    ...
    def toCNF(self):
        ...
        extra=TrueConstant
        o = And(temp1,extra).flattenArgs();
        n = And(temp2,extra).flattenArgs();
        o.remove(extra)
        n.remove(extra)
        answer = extra
        for f1 in o:
            for f2 in n:
                answer = And(Or(f1,f2),answer)
        return answer
...
class Not(Formula):
    ...
    def truthValue(self, truthDict):
        ...
        a=self.arg.truthValue(truthDict)
...
def Equivalence(arg1, arg2):
    ...
    return Or(And(Not(arg1),Not(arg2)),And(arg1,arg2)).toCNF()
